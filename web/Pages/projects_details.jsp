<%-- 
    Document   : get_involved_ways
    Created on : Jun 29, 2015, 3:04:44 PM
    Author     : JMwash
--%>
                    ...
                    <div class="col-md-12 no-pad">
                        <div class="col-md-4 col-sm-4">
                            <div class="card">
                                ...
                                <div class="avatar">
                                    <img class="img-circle" src="http://lorempixel.com/250/250/cats/1" alt="">
                                </div>
                                <div class="content">
                                    <p>Mother Jane <br>
                ...
                <div class="row coralbg white">
                    ...
                    <div class="col-md-12 no-pad">
                        <div class="plan-name-gray col-md-4 col-sm-4 drop_shadow ">
                            ...
                            <hr>
                            <a href="donate.htm" class="btn btn-primary" title="Enlace">Donate Money/Resources</a>
