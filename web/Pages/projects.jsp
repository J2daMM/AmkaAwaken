...
<div class="container text-center white_shadow">
    <h1 class="page_title ">Our Projects</h1>
...
<!--                            <a href="projects_details.htm" class="btn btn-primary btn-sm" role="button">Details</a>-->
<!--                            <button class="btn btn-primary btn-sm" role="button">Details</button>-->
                        </div>
                        <div class="panel-figure">
                            <img class="img-responsive img-circle" src="https://s3.amazonaws.com/uifaces/faces/twitter/adellecharles/73.jpg" />
                        </div>
                        <div class="panel-body text-center">
                            <!--                            <h4 class="panel-header"><a href="projects_details.htm">@Maridlcrmn</a></h4>-->
                            <a href="projects_details.htm" class="btn btn-primary btn-sm" role="button">Project Details</a>
