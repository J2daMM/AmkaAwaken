...
<div class="container text-center white_shadow">
    <h1 class="page_title ">Donate Today</h1>
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <h2>Your Donation goes a long way. <span class="text-muted"> Thank you. </span></h2>
        </div>
        ...
        <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1 gray_shadow">
            <div class="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1">
                <ul class="nav nav-tabs">
                    ...
                    <li><a href="#tab3" data-toggle="tab">OTHER DONATION WAYS</a></li>
                </ul>
            </div>
            <!-- TAB CONTENT -->
...
<!--                                    <div class="pull-left" >                            
                ...
                <div class="tab-pane" id="tab2">
                    Link to PayPal(Redirecting to paypal.com)
                </div>
